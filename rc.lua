...
-- Load the pulseaudio volume widget.
...
local layouts = {
    ...
    awful.layout.suit.mamagnifier
}
-- }}}

-- {{{ Tags
tags = {
    names = { "terms", "www", "fileman", "im", "media", "editor", "other" },
    layout = { layouts[3], layouts[1], layouts[1], layouts[6], layouts[1],layouts[7], layouts[1] }
}
...
for s = 1, screen.count() do
    ...
    -- Volumes widgets from copycat that didn't worked
